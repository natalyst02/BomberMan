...
public class Screen {
	...
	public void drawEndGame(Graphics g, int points, String code) {
		...
		g.drawImage(mshi,0, 0,getRealWidth(), getRealHeight(),
				null);
		Font font = new Font("Arial", Font.PLAIN, 20 * Game.SCALE);
		g.setFont(font);
		g.setColor(Color.blue);
		drawCenteredString("GAME OVER", getRealWidth(), getRealHeight() - (Game.TILES_SIZE * 2) * Game.SCALE, g);
		...
		g.setFont(font);
		g.setColor(Color.red);
		drawCenteredString("YOU ARE SO NOOB !", getRealWidth(), getRealHeight() + (Game.TILES_SIZE * 6) * Game.SCALE, g);
	}
